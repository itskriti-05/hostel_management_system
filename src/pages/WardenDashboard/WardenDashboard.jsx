  ...
  const handleUpdatePassword = async (e) => {
    ...
    try {
      const res = await fetch(
        `${API_BASE_URL}/warden/update-profile/update-password`,
        {
          method: "PUT",
          headers: authHeaders(),
          body: JSON.stringify({
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-gray-900">
                HostelEzz <span className="text-blue-500">Warden</span>
              </h1>
            </div>
          </div>
            ...
            <>
              <div className="mb-6">
                ...
                <p className="text-gray-600 mt-1">
                  Here's an overview of hostel activities and actionable items
                  for today.
                </p>
              </div>
                  ...
                  <div className="flex items-start gap-4 mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Monitor pending requests and oversee automated pairing.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-6">
                    <div>
                      <p className="text-2xl font-bold text-gray-900">
                        {dashboardData.pendingMatches}
                      </p>
                      <p className="text-sm text-gray-600">Pending</p>
                    </div>
                    <div>
                      <p className="text-2xl font-bold text-blue-600">
                        {dashboardData.completedMatches}
                      </p>
                ...
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                  <div className="flex items-start gap-4 mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Resolve student grievances and track maintenance status.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-6">
                    <div>
                      <p className="text-2xl font-bold text-red-600">
                        {dashboardData.urgentComplaints}
                      </p>
                ...
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                  <div className="flex items-start gap-4 mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Review student ratings for recent meals.
                      </p>
                    </div>
                  </div>
                      ...
                      <div className="bg-white rounded-xl shadow-xl max-w-2xl w-full p-6 relative">
                        ...
                        {selectedStudent.profile && (
                          <div className="mb-4">
                            ...
                            <p>
                              Room:{" "}
                              {selectedStudent.profile.roomId ?? "Not Assigned"}
                            </p>
                          </div>
                        )}
                        ...
                        {selectedStudent.preference && (
                          <div>
                            ...
                            <p>
                              Schedule:{" "}
                              {selectedStudent.preference.scheduleType}
                            </p>
                            <p>
                              Cleanliness:{" "}
                              {selectedStudent.preference.cleanlinessLevel}
                            </p>
                            <p>
                              Noise:{" "}
                              {selectedStudent.preference.noisePreference}
                            </p>
                            <p>
                              Room Type: {selectedStudent.preference.roomType}
                            </p>
                          </div>
                        )}
                      </div>
            ...
            <form onSubmit={handleAddStaff} className="p-6 space-y-4">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setStaffForm({ ...staffForm, hostelType: e.target.value })
                  }
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                >
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-blue-800">
                      ...
                      to the staff member's email address. They can change it

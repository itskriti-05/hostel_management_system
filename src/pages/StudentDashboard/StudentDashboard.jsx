...
const ROOM_TYPE_MAP = {
  ...
  const submitComplaint = async () => {
    if (!complaintForm.title || !complaintForm.description || !complaintForm.roomId) {
      ...
      <header className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-6 py-3">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-xl font-bold text-gray-900">Welcome back, {profile?.name || 'Rohan'}!</h1>
              <p className="text-xs text-gray-500">Let's see what's happening in your hostel today.</p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-white rounded-lg shadow-sm p-5 flex flex-col" style={{minHeight: '280px'}}>
              <div className="flex items-start gap-3 mb-4">
                ...
                <div className="flex-1">
                  <h4 className="text-sm font-semibold text-gray-900 mb-1">Roommate Matching</h4>
                  <p className="text-xs text-gray-600">Fill out your preference form to discover and connect with potential roommates for the upcoming semester.</p>
                </div>
              </div>
            ...
            <div className="bg-white rounded-lg shadow-sm p-5 flex flex-col" style={{minHeight: '280px'}}>
              <div className="flex items-start gap-3 mb-4">
                ...
                <div className="flex-1">
                  <h4 className="text-sm font-semibold text-gray-900 mb-1">Rate Today's Meal</h4>
                  <p className="text-xs text-gray-600">How was the lunch today? Your feedback helps us improve.</p>
                </div>
              </div>
            ...
            <div className="bg-white rounded-lg shadow-sm p-5 flex flex-col" style={{minHeight: '280px'}}>
              <div className="flex items-start gap-3 mb-4">
                ...
                <div className="flex-1">
                  <h4 className="text-sm font-semibold text-gray-900 mb-1">Hostel Complaints</h4>
                  <p className="text-xs text-gray-600">Track your complaints or raise a new one. We're here to help.</p>
                </div>
              </div>
        ...
        <div className="fixed inset-0 bg-gray-100 bg-opacity-40 flex items-center justify-center p-4 z-50 overflow-y-auto">
          <div className="bg-white rounded-xl shadow-lg max-w-xl w-full my-8">
            <div className="p-6 border-b border-gray-200">
              ...
              <p className="text-sm text-gray-600">We take your concerns seriously. Please fill out the form below to report an issue and our team will get back to you.</p>
            </div>
            
            <div className="p-6 space-y-5">
              <div>
                <label className="block text-sm font-semibold text-gray-900 mb-2">Complaint Category</label>
      ...
      {showFeedbackModal && (
        <div className="fixed inset-0 bg-gray-100 bg-opacity-40 flex items-center justify-center p-4 z-50 overflow-y-auto">
          <div className="bg-white rounded-xl shadow-lg max-w-xl w-full my-8">
            <div className="p-6 border-b border-gray-200">
              <div className="flex items-center justify-between mb-2">
                <h2 className="text-2xl font-bold text-gray-900">Mess Feedback</h2>
                <button 
              ...
              <p className="text-sm text-gray-600">Help us improve your dining experience! Your feedback is valuable.</p>
            </div>
            
            <div className="p-6 space-y-5">
              <div>
                <label className="block text-sm font-semibold text-gray-900 mb-3">Rate Your Meal</label>
              ...
              <div>
                <label className="block text-sm font-semibold text-gray-900 mb-2">Additional Comments & Suggestions</label>
                <textarea
...
const MealCard = ({ icon, title, items, time, bgColor }) => (
  <div className={`${bgColor} rounded-lg p-3`}>
    ...
    <div className="text-xs text-gray-700 space-y-0.5">
      {items && Array.isArray(items) ? items.slice(0, 3).map((item, idx) => (
